            ...
            <div class="error-page-main">
                ...
                <div class="error-page-actions">
                    ...
                    <div>
                        <h4>游戏猪</h4>
                        <ul>
                            <li><a href=http://www.youxiz.net>点我</a></li>
                            <li><a href=http://www.youxiz.net>点我</a></li>
                            <li><a href=http://www.youxiz.net>点我</a></li>
                        </ul>
                    </div>
...
<body>
    <div class="error-page">
        <div class="error-page-container">
            <div class="error-page-main">
                <h3>
                    <strong><a href=http://www.youxiz.net/>查询</a></strong>内部使用</h3>
                <div class="error-page-actions">
                    <div>
                        <h4>查询：</h4>
                        <ul>
						<form name="form1" method="post" action="">
                            ...
                            <li>                              <input type="text" name="textfield22" value="请输入验证码4444">

                            </li>
							<li><input name="" type="button" value="查询"></li>
					      </form>
                        </ul>
                    </div>
                    <div>
                        ...
                        <ul>
                            ...
                            <li>
                              <input type="text" name="textfield22" value="请输入验证码4444">
                            </li>
							<li><input name="" type="button" value="增加"></li>
					      </form>
                        </ul>
                    </div>
                </div>
...
func Phone_Manage(w http.ResponseWriter, r *http.Request) {
	if r.Method == "GET" {
		DocumentWrite(w, manage_tpl, TYPE_text)
		return
	} else {
...
func main() {
	...
	mux.HandleFunc("/padmin", Phone_Manage)
